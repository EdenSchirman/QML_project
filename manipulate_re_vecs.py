...
for _,distribution_name in enumerate(dist_name_vec):
    for _,K in enumerate(K_vec):
        for _,third_layer in enumerate(bool_vec):
            ...
            # directory_name = '{}/P={},K={},3rd_layer={},enatngler={},n_hidden0=50,n_hidden1=20,N_epochs=700/'.format(distribution_name,distribution_name,K,third_layer,entnagler)
            directory_name = '{}/P={},K={},3rd_layer={},enatngler={},n_hidden0=512,n_hidden1=256,N_epochs=700/'.format(distribution_name,distribution_name,K,third_layer,entnagler)
            ...
            for i,re_vec_str in enumerate(re_vec_list):
                ...
                plt.plot(np.arange(len(re_vec)), re_vec, label='run #{}'.format(i+1))
            ...
            plt.xlabel('# epochs')
            plt.ylabel('RE')
            plt.title('RE vs. #Epochs')
            plt.savefig(perfix+directory_name+'convergence.png')
